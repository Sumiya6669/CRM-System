...
export const AuthProvider = ({ children }) => {
  ...
  const loadCurrentUser = useCallback(async () => {
    ...
    try {
      ...
      if (!currentProfile) {
        ...
        setProfile(null);
        setAuthError({ type: 'user_not_registered', message: 'User profile is not registered' });
  ...
  const signUp = useCallback(async ({ email, password, fullName, inviteToken }) => {
    await authService.signUp({ email, password, fullName, inviteToken });
  }, []);
